export const contactListApi = [
    {
        ...
        imgurl:<img src="https://pps.whatsapp.net/v/t61.24694-24/295884633_367317302226092_7969507390616434118_n.jpg?stp=dst-jpg_s96x96&amp;ccb=11-4&amp;oh=01_AdRcWk7i4nKLUxaVSs0CA-9UnxZQvZPQU4qiclIy40mdHg&amp;oe=654DAE51&amp;_nc_sid=000000&amp;_nc_cat=110" alt="" draggable="false" class="g0rxnol2 f804f6gw ln8gz9je ppled2lx gfz4du6o r7fjleex g9p5wyxn i0tg5vk9 aoogvgrq o2zu3hjb jpthtbts lyqpd7li bs7a17vp csshhazd _11JPr" tabindex="-1"/>,
        latestmessage:"Hello man how's it going?",
        messages:[
            {
                sender:"Hello man",
                receiver:"Ki obostha?"
    ...
    {
        name:"Ashequl Arefin",
        imgurl: <img src="./images/anik.jpg" alt=""/>  ,
        latestmessage:"Hello man how's it going?",
        messages:[
            {
                sender:"Hello man",
    ...
    {
        name:"Saiful Islam",
        imgurl: <img src="./images/farhan.enc" alt=""/> ,
        latestmessage:"Hello man how's it going?",
        messages:[
            {
                sender:"Hello man",
    ...
    {
        name:"Ishraq Arafat",
        imgurl:<img src="./images/rinku.enc" alt=""/>,
        latestmessage:"Hello man how's it going?",
        messages:[
            {
                sender:"Hello man",
